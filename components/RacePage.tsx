    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="text-center animate-fade-in-up">
                <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tighter text-light">The Race</h1>
                <p className="mt-4 max-w-3xl mx-auto text-lg text-light/80">
                    JayNdaboX must survive the urban landscape in a one-of-a-kind ESk8 manhunt. Track the action live on race day.
                </p>
            </div>
            ...
            <div className="mt-20">
                 ...
                 <div className="aspect-video bg-black border-2 border-primary rounded-lg shadow-2xl shadow-primary/20 flex items-center justify-center p-4">
                     <div className="text-center">
                        <p className="text-2xl font-bold text-light/60">Race Day Feed Will Appear Here</p>
